...
//////////////////////////////////////////////////////////////////////
CGOPItem::CGOPItem(CSecID camID) 
{
	m_camID = camID;
	m_dwIndex = 0;
...
#ifdef TRACE_LOCKS
	m_GOPs.m_nCurrentThread = theApp.m_bTraceLocks ? 0 : -1;
#endif
}
//////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////
void CGOPSendThread::SetParent(CIPCOutputServerClient* pParent)
{
	m_pParent = pParent;
}
//////////////////////////////////////////////////////////////////////
void CGOPSendThread::AddPictureRecord(const CIPCPictureRecord& pict, DWORD dwMDX, DWORD dwMDY)
{
	BOOL bFound = FALSE;
	CGOPItem* pGOPItem = NULL;

	m_GOPs.Lock(_T(__FUNCTION__));
	...
	if (!bFound)
	{
		pGOPItem = new CGOPItem(pict.GetCamID());
		m_GOPs.Add(pGOPItem);
	}
	...
	if (m_pParent)
	{
		...
		for (int i=0;i<m_GOPs.GetSize();i++)
		{
			...
			if (pGOPItem)
			{
				...
				if (pPict)
				{
					m_pParent->SendPicture(*pPict,pPict->GetCompressionType(),pPict->GetCompression(),x,y);
					WK_DELETE(pPict);
				}
			}
		}
