...
void CQueryParameter::Save(const CString& sSection, CWK_Profile& wkp)
{
	...
	wkp.WriteString(sSection,_T("DateExact"),
		m_bExactDate ? (LPCTSTR)m_stDateExact.ToString() : NULL);
	wkp.WriteString(sSection,_T("TimeExact"),
		m_bExactTime ? (LPCTSTR)m_stTimeExact.ToString() : NULL);

	wkp.WriteString(sSection,_T("PCDateEnd"),
		m_bExactDate && m_bTimeFromTo ? (LPCTSTR)m_stPCDateEnd.ToString() : NULL);
	wkp.WriteString(sSection,_T("TimeEnd"),
		m_bExactTime && m_bTimeFromTo ? (LPCTSTR)m_stTimeEnd.ToString() : NULL);
}
//////////////////////////////////////////////////////////////////////
