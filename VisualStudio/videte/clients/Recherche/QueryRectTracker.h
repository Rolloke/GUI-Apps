...
{
public:
	CQueryRectTracker(CSmallWindow* pSmallWindow);
...
public:
	...
	void			SaveLastVideoClientRect(CRect rcVideoClient); //speichert VideoClient Winsow Koords
...
private:
	...
	CSmallWindow*	m_pSmallWindow;			//Pointer auf DisplayWindow, auf dem
	...
	CRect			m_rcLastVideoClientRect;//VideoClientWindow Daten des vorgerigen VideoClients
	...
	int				m_iRectMinSizeDefault;	//Minimale Rechteck Größe
	int				m_iRectMinSizeCurrent;	//Aktuelle minimale Größe, abh. vom Zoomfaktor
