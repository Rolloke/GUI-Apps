// DlgHTMLmap.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CDlgHTMLmap dialog
CDlgHTMLmap::CDlgHTMLmap(CWnd* pParent /*=NULL*/)
	: CSkinDialog(CDlgHTMLmap::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgHTMLmap)
...
//////////////////////////////////////////////////////////////////////////
void CDlgHTMLmap::DoDataExchange(CDataExchange* pDX)
{
	CSkinDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgHTMLmap)
	...
	if (!pDX->m_bSaveAndValidate)
	{
		...
		int i, n = pMF->GetNoOfMonitors();
		CRect rc;
		for (i=0; i<n; i++)
		{
			pMF->GetMonitorRect(i, rc);
...
/////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CDlgHTMLmap, CSkinDialog)
	//{{AFX_MSG_MAP(CDlgHTMLmap)
...
/////////////////////////////////////////////////////////////////////////////
void CDlgHTMLmap::OnBtnHmPictureFilename() 
{
	{	// nur Updaten
...
//////////////////////////////////////////////////////////////////////////
void CDlgHTMLmap::OnChange() 
{
	m_cBtnOK.EnableWindow(TRUE);
}
//////////////////////////////////////////////////////////////////////////
void CDlgHTMLmap::OnChangeZoom() 
{
	if (m_cBtnOK.m_hWnd)
	{
...
//////////////////////////////////////////////////////////////////////////
void CDlgHTMLmap::CheckPictureFile()
{
	CString sPath;
	CFile FilePict;
...
//						m_szPicture.cx = MulDiv(m_szPicture.cx, wXdensity, nDX);
//						m_szPicture.cy = MulDiv(m_szPicture.cy, wYdensity, nDY);
						m_szPicture.cx = MulDiv(m_szPicture.cx, wXdensity * ::GetDeviceCaps(hDC, HORZSIZE), ::GetDeviceCaps(hDC, HORZRES));
						m_szPicture.cy = MulDiv(m_szPicture.cy, wYdensity * ::GetDeviceCaps(hDC, VERTSIZE), ::GetDeviceCaps(hDC, VERTRES));
						::ReleaseDC(m_hWnd, hDC);
					}
				}
			}
...
//////////////////////////////////////////////////////////////////////////
void CDlgHTMLmap::CheckCopyPictureFile()
{
...
//////////////////////////////////////////////////////////////////////////
void CDlgHTMLmap::OnOK() 
{
	// Den Text für die Funktion 'DDV_MinMaxInt' trimmen.
	GetDlgItem(IDC_EDT_HM_TITLE)->GetWindowText(m_sTitle);
	m_sTitle.Trim();
	GetDlgItem(IDC_EDT_HM_TITLE)->SetWindowText(m_sTitle);
