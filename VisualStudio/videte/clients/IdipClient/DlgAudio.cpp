...
/////////////////////////////////////////////////////////////////////////////
// CDlgAudio dialog
CDlgAudio::CDlgAudio(CIPCAudioIdipClient *pCI,CIPCAudioIdipClient *pCO, CWnd* pParent /*=NULL*/)
	: CSkinDialog(CDlgAudio::IDD, pParent)
{
	m_pControlInput  = pCI;
...
/////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CDlgAudio, CSkinDialog)
...
{
//	GetDlgItem(IDC_SLIDER_AU_INPUT_SENSITIVITY)->ModifyStyleEx(0, WS_EX_TRANSPARENT);
//	GetDlgItem(IDC_SLIDER_AU_OUTPUT_VOLUME)->ModifyStyleEx(0, WS_EX_TRANSPARENT);
...
void CDlgAudio::InitCtrls()
{
	if (m_pControlInput)
	{
		CAutoCritSec cs(m_pControlInput->GetCSAudio());
	...
	if (m_pControlOutput)
	{
		CAutoCritSec cs(m_pControlOutput->GetCSAudio());
		int nValue = m_pControlOutput->GetOutputVolume();
		if (nValue == -1)
		{
			m_cOutputVolume.EnableWindow(FALSE);
			m_bVolumeInitialized = false;
...
/////////////////////////////////////////////////////////////////////////////
void CDlgAudio::OnReleasedcaptureSliderAuInputSensitivity(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
/////////////////////////////////////////////////////////////////////////////
void CDlgAudio::OnReleasedcaptureSliderAuOutputVolume(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
/////////////////////////////////////////////////////////////////////////////
void CDlgAudio::OnReleasedcaptureSliderAuThreshold(NMHDR* pNMHDR, LRESULT* pResult) 
{
	if (m_pControlInput)
	{
...
/////////////////////////////////////////////////////////////////////////////
void CDlgAudio::OnSelchangeComboNamedInputs()
{
...
/////////////////////////////////////////////////////////////////////////////
void CDlgAudio::OnSelchangeComboAuInputChannels()
{
...
/////////////////////////////////////////////////////////////////////////////
LRESULT CDlgAudio::OnNotifyWindowI(WPARAM dwCmd, LPARAM nID)
{
	return OnNotifyWindow(m_pControlInput, dwCmd, nID);
}
//////////////////////////////////////////////////////////////////////////
LRESULT CDlgAudio::OnNotifyWindowO(WPARAM dwCmd, LPARAM nID)
{
	return OnNotifyWindow(m_pControlOutput, dwCmd, nID);
}
LRESULT CDlgAudio::OnNotifyWindow(CIPCAudioIdipClient*pCIPC, WPARAM dwCmd, LPARAM nID)
{
	...
	if (nID == MEDIA_IDR_INPUT_PINS)
	{
		switch (MEDIA_COMMAND_VALUE(dwCmd))
		{
			...
			{
				CAutoCritSec cs(pCIPC->GetCSAudio());
	...
	else if (MEDIA_COMMAND_VALUE(dwCmd) == MEDIA_DISCONNECT)
	{
		m_pControlInput = NULL;
		m_pControlOutput = NULL;
		OnCancel();
		return 0;
	}
...
/////////////////////////////////////////////////////////////////////////////
BOOL CDlgAudio::OnNotify(WPARAM wParam, LPARAM lParam, LRESULT* pResult) 
{
...
void CDlgAudio::OnLButtonUp(UINT nFlags, CPoint point) 
{
	CRect rect;
...
void CDlgAudio::OnRdStereoChannel() 
{
	CDataExchange dx(this, TRUE);
