================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : IdipClient Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese IdipClient-Anwendung erstellt. 
...
Ihre IdipClient-Anwendung bilden.
...
res\IdipClient.ico
    ...
    Symbol wird durch die Haupt-Ressourcendatei IdipClient.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie das Array IDR_MAINFRAME TOOLBAR in IdipClient.rc, um 
    Schaltflächen für die Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Anwendungs-Assistent erstellt einen Dokumenttyp und eine Ansicht:

IdipClientDoc.h, IdipClientDoc.cpp - das Dokument
    Diese Dateien enthalten die Klasse CIdipClientDoc.  Bearbeiten Sie diese Dateien,
    um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
    Dateien zu implementieren (mit CIdipClientDoc::Serialize).
IdipClientView.h, IdipClientView.cpp - die Ansicht des Dokuments
    Diese Dateien enthalten die Klasse CIdipClientView.
    CIdipClientView-Objekte werden verwendet, um CIdipClientDoc-Objekte anzuzeigen.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    ...
    IdipClient.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
