/////////////////////////////////////////////////////////////////////////////
// FILE:		$Workfile: wk.h $
// ARCHIVE:		$Archive: /Project/Include/wk.h $
// CHECKIN:		$Date: 2/17/06 9:47a $
// VERSION:		$Revision: 25 $
// LAST CHANGE:	$Modtime: 2/17/06 9:47a $
...
/////////////////////////////////////////////////////////////////////////////
inline int GetTimeSpanSigned(DWORD dwStartTime, DWORD dwActualTime)
{
	static const int nOneDay = 24*60*60*1000;
	int nSpan = dwActualTime - dwStartTime;
	if (nSpan > nOneDay)
	{
		nSpan = dwStartTime - dwActualTime;
	}
	return nSpan;
}
/////////////////////////////////////////////////////////////////////////////
inline int GetTimeSpanSigned(DWORD dwStartTime)
{
	return GetTimeSpanSigned(dwStartTime, GetTickCount());
}
/////////////////////////////////////////////////////////////////////////////
...
{
	return GetTimeSpan(dwStartTime, GetTickCount());
}
/////////////////////////////////////////////////////////////////////////////
