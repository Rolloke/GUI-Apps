...
// ARCHIVE:		$Archive: /Project/Units/GenericUnit/CMDConfigDlg.cpp $
...
BOOL CMDConfigDlg::OnInitDialog() 
{
	...
	if (!EnableToolTips(TRUE))
		WK_TRACE("Konnte Tooltips nicht aktivieren\n");
...
/////////////////////////////////////////////////////////////////////////////
void CMDConfigDlg::ShowConfigDlg() 
{
	SOURCE_SELECT_STRUCT SrcSel,NextSrcSel;
	SrcSel.wSource		= m_wSubID;
	SrcSel.wFormat		= ENCODER_RES_HIGH;
...
/////////////////////////////////////////////////////////////////////////////
void CMDConfigDlg::ClientToScreen(int nID, int &nX, int &nY) 
{
	if (nID == IDC_INLAY_WND)
	{
		nX += m_rcInlayScreen.left;
		nY += m_rcInlayScreen.top;
	}
	else if (nID == IDC_DIFF_WND)
	{
		nX += m_rcMaskScreen.left;
		nY += m_rcMaskScreen.top;
	}
}
