...
// ARCHIVE:		$Archive: /Project/Units/USBCAM/USBCamUnit/cmdconfigdlg.cpp $
// CHECKIN:		$Date: 17.11.03 14:01 $
// VERSION:		$Revision: 3 $
// LAST CHANGE:	$Modtime: 28.04.03 12:50 $
// BY AUTHOR:	$Martin $
// $Nokeywords:$
//////////////////////////////////////////////////////////////////////
...
CMDConfigDlg::CMDConfigDlg(CMotionDetection* pMD, CWnd* pParent /*=NULL*/)
	: CMDConfigDlgBase(pMD, pParent, CMDConfigDlg::IDD)
{
...
BOOL CMDConfigDlg::OnInitDialog() 
{
	...
	CComboBox* pCombo = (CComboBox*)GetDlgItem(IDC_SELECT_CAMERA);
	pCombo->InsertString(0, _T("MyCam"));
/*
