// CIPCInputUSBcamUnitMDAlarm.cpp: implementation of the CIPCInputUSBcamUnitMDAlarm class.
//
//////////////////////////////////////////////////////////////////////
...
CIPCInputUSBcamUnitMDAlarm::CIPCInputUSBcamUnitMDAlarm(CUSBCamUnitDlg* pMainWnd, LPCTSTR shmName)
...
//////////////////////////////////////////////////////////////////////////////////////
void CIPCInputUSBcamUnitMDAlarm::OnRequestSetEdge(WORD wGroupID, DWORD dwEdgeMask)
{
//	TRACE("CIPCInputUSBcamUnitMDAlarm::OnRequestSetEdge\tGroupID=%i\t0x%lx\n", wGroupID, dwEdgeMask);

	if (wGroupID != m_wGroupID)
	{
		WK_TRACE_ERROR("CIPCInputUSBcamUnitMDAlarm::OnRequestSetEdge\tWrong wGroupID\n");
		return;
	}
...
//////////////////////////////////////////////////////////////////////////////////////
void CIPCInputUSBcamUnitMDAlarm::OnRequestSetFree(WORD wGroupID, DWORD dwOpenMask)
{
//	TRACE("CIPCInputUSBcamUnitMDAlarm::OnRequestSetFree\tGroupID=%i\tOpenMask=0x%lx\n",wGroupID, dwOpenMask);

	if (wGroupID != m_wGroupID)
	{
		WK_TRACE_ERROR("CIPCInputUSBcamUnitMDAlarm::OnRequestSetFree\tWrong wGroupID\n");
		return;
	}
...
{
	WK_TRACE("CIPCInputUSBcamUnitMDAlarm::OnRequestReset\tGroupID=%i\n", wGroupID);

	if (wGroupID != m_wGroupID)
	{
		WK_TRACE_ERROR("CIPCInputUSBcamUnitMDAlarm::OnRequestReset\tWrong wGroupID\n");
...
{
	// TRACE("CIPCInputUSBcamUnitMDAlarm::OnRequestAlarmState\tGroupID=%i\n", wGroupID);
 
	if (wGroupID != m_wGroupID)
	{
		WK_TRACE_ERROR("CIPCInputUSBcamUnitMDAlarm::OnRequestAlarmState\tWrong wGroupID\n");
		return;
	}
...
{
//	TRACE("CIPCInputUSBcamUnitMDAlarm::OnResponseAlarmState   Not Yet \n");

   	if (wGroupID != m_wGroupID)
	{
		WK_TRACE_ERROR("CIPCInputUSBcamUnitMDAlarm::OnResponseAlarmState\tWrong wGroupID\n");
		return;
	}
}
...
{
//	TRACE("CIPCInputUSBcamUnitMDAlarm::OnResponseInputs   Not Yet\n");

   	if (wGroupID != m_wGroupID)
	{
		WK_TRACE_ERROR("CIPCInputUSBcamUnitMDAlarm::OnResponseInputs\tWrong wGroupID\n");
		return;
	}
}
...
/*void CIPCInputUSBcamUnitMDAlarm::AlarmStateChanged(WORD wAlarmState)
{
	...
	//	WK_TRACE("CIPCInputUSBcamUnitMDAlarm::AlarmStateChanged (0x%x,0x%x)\n", dwNewState, m_dwAlarmState);
