...
// ARCHIVE:		$Archive: /Project/Units/USBCAM/MotionDetection/cmdconfigdlgbase.h $
// CHECKIN:		$Date: 21.08.03 14:45 $
// VERSION:		$Revision: 1 $
// LAST CHANGE:	$Modtime: 27.03.03 11:28 $
// BY AUTHOR:	$Martin $
// $Nokeywords:$
//////////////////////////////////////////////////////////////////////
...
// Construction
public:
	CMDConfigDlgBase(CMotionDetection* pMD, CWnd* pParent, int nResourceID);   // standard constructor
