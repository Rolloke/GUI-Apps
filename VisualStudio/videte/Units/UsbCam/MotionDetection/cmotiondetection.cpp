...
// ARCHIVE:		$Archive: /Project/Units/USBCAM/MotionDetection/cmotiondetection.cpp $
...
//////////////////////////////////////////////////////////////////////
CMotionDetection::CMotionDetection(const CString& sIniName, CSize &szCapture, LPCTSTR sMask)
{
	int nI;
	char szBuffer[255]		={0};
	...
	// Außmaße der Videoinlays für die Bewegungserkennung.
...
//	m_nCaptureSizeV = ReadConfigurationInt(_T("MotionDetection"), _T("CaptureSizeV"), CAPTURE_SIZE_V, m_sIniName);
	m_nCaptureSizeH = szCapture.cx;
	m_nCaptureSizeV = szCapture.cy;
	...
	m_sMaskPath = sHomePath+sMask+_T("\\");
