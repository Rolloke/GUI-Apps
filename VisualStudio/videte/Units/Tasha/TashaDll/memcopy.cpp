/////////////////////////////////////////////////////////////////////////////
// PROJECT:		TashaUnit
// FILE:		$Workfile: memcopy.cpp $
// ARCHIVE:		$Archive: /Project/Units/Tasha/TashaDll/memcopy.cpp $
...
#ifdef _DEBUG
	if (!m_bMMX)
		ML_TRACE(_T("No MMX Instructions supported\n"));
	if (!m_bSFenc2)
		ML_TRACE(_T("No SFENCE Instruction supported\n"));
#endif
