...
// ARCHIVE:		$Archive: /Project/Units/Tasha/TashaSys/Eventlog.c $
// CHECKIN:		$Date: 25.03.04 11:26 $
// VERSION:		$Revision: 2 $
// LAST CHANGE:	$Modtime: 25.03.04 10:32 $
...
/////////////////////////////////////////////////////////////////////////////////////
BOOLEAN TashaReportEvent(IN NTSTATUS	ErrorCode,
						...
						)
{
	...
	UCHAR PacketSize;
	UCHAR StringSize[TASHA_MAX_INSERTION_STRINGS];
	ULONG i;
	...
	if (StringCount > 0)
	{
		...
		if (StringCount > TASHA_MAX_INSERTION_STRINGS )
			StringCount = TASHA_MAX_INSERTION_STRINGS;

		for (i = 0; i < StringCount; i++)
		{
			// Keep track of individual string sizes
			StringSize[i] =	(UCHAR)TashaGetStringSize(Strings[i]);
