...
{	
 	...
 	switch (nMessageID)
	{
		...
		case TMM_REQUEST_GET_ENCODER_PARAMETER:
			bResult = RequestGetEncoderParam();
			break;       		
	}
...
{
	pPacket->dwStreamID  = (DWORD) ((dwParam1>>18) & 0x03);
...
/////////////////////////////////////////////////////////////////////////////
bool RequestGetEncoderParam()
{
	DWORD dwVal,dwBitRate;
	dwBitRate = lVideoEncParam.BitRate/1000;
	dwVal = dwBitRate<<20|pPacket->dwStreamID<<18|lVideoEncParam.GOVLength<<12|pPacket->eType<<8|lVideoEncParam.TimerResolution<<3;
