...
// FILE:		$Workfile: Sports.h $
// ARCHIVE:		$Archive: /Project/Units/Tasha/TashaFirmware/TashaFirmware535/Sports.h $
// CHECKIN:		$Date: 15.04.04 16:24 $
// VERSION:		$Revision: 27 $
// LAST CHANGE:	$Modtime: 15.04.04 16:24 $
