...
// FILE:		$Workfile: TashaFirmware535.h $
// ARCHIVE:		$Archive: /Project/Units/Tasha/TashaFirmware/TashaFirmware535/TashaFirmware535.h $
...
//#define CORE_CLK	(300000000)	// Ist in den Compiler Optionen definiert 
...
//######## DoRequest/OnConfirm ########
BOOL PollAlarmState();
BOOL DoNotifyAlarmStateChanged(BYTE byAlarmState);

BOOL PollAdapterSelectState();
BOOL DoNotifyAdapterSelectStateChanged(BYTE byAdapterSelectState);

BOOL PollPCKeysState();
BOOL DoNotifyPCKeysStateChanged(BYTE byPCKeysState);
