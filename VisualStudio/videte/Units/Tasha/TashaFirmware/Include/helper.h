...
// ARCHIVE:		$Archive: /Project/Units/Tasha/TashaFirmware/Include/helper.h $
// CHECKIN:		$Date: 21.04.04 13:27 $
// VERSION:		$Revision: 19 $
// LAST CHANGE:	$Modtime: 21.04.04 12:56 $
...
extern "C" void startc2();
extern "C" int  stopc();
extern "C" int  resumec();
