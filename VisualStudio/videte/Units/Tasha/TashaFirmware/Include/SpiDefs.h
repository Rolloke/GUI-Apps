...
// FILE:		$Workfile: SpiDefs.h $
// ARCHIVE:		$Archive: /Project/Units/Tasha/TashaFirmware/Include/SpiDefs.h $
// CHECKIN:		$Date: 28.01.04 15:21 $
// VERSION:		$Revision: 3 $
// LAST CHANGE:	$Modtime: 19.01.04 11:24 $
