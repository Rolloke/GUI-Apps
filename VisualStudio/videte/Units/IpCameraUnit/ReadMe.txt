================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : IPCameraUnit Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese IPCameraUnit-Anwendung erstellt. 
...
Ihre IPCameraUnit-Anwendung bilden.
...
res\IPCameraUnit.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
    Symbol wird durch die Haupt-Ressourcendatei IPCameraUnit.rc eingebunden.

res\IPCameraUnit.rc2
...
IPCameraUnitDlg.h, IPCameraUnitDlg.cpp - das Dialogfeld
    Diese Dateien enthalten die Klasse CIPCameraUnitDlg. Diese Klasse legt das
    Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
    felds befindet sich in IPCameraUnit.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
    ...
    IPCameraUnit.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
