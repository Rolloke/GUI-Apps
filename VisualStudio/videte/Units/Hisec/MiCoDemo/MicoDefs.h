...
#define WK_TRACE_WARNING	TRACE
#define WK_DELETE(p)	delete p; p=NULL;

#define SETBIT(w,b)    ((DWORD)((DWORD)(w) | (1L << (b))))
#define CLRBIT(w,b)    ((DWORD)((DWORD)(w) & ~(1L << (b))))
#define TSTBIT(w,b)    ((BOOL)((DWORD)(w) & (1L << (b)) ? TRUE : FALSE))

#define GET_SECOND(a)	(WORD)((a>>0) & 0x0000003fL)
#define GET_MINUTE(a)	(WORD)((a>>6) & 0x0000003fL)
#define GET_HOUR(a)		(WORD)((a>>12)& 0x0000001fL)
#define GET_DAY(a)		(WORD)((a>>17)& 0x0000001fL)
#define GET_MONTH(a)	(WORD)((a>>22)& 0x0000000f)
#define GET_YEAR(a)		(WORD)((a>>26)& 0x0000003fL)	+ 1980

// Versionsnummer von MiCoUnit und MiCo.vxd				   
#define MICO_UNIT_VERSION				0x0352
#define MICO_VXD_VERSION				0x0352

// Name der benutzten Inidatei
#define MICOUNIT_INI					"MICOUNIT.INI"

// DeviceIOControl-Funktionsnummern 
#define MICO_VXD_OPEN					1
#define MICO_VXD_CLOSE					2
#define MICO_VXD_GETVERSION				3

// USERDEF Messages
#define MICO_MSGBASE					WM_USER
...
#define WM_MICO_REQUEST_RESET			MICO_MSGBASE + 7
...
#define MICO_ERR_TIMEOUT				 14
#define MICO_ERR_WAITFAILED				 15
#define MICO_ERR_UNVALID_FIELD			 16
#define MICO_ERR_ENCODER_OFF			 17
