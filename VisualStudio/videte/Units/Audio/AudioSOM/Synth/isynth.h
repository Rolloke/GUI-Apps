...
// ISynthesizer
//
DECLARE_INTERFACE_(ISynthesizer, IUnknown) {
    ...
    STDMETHOD(get_OffsetDegree) (THIS_
                  int    *Offset     /* [out] */    // Change to this Offset
              ) PURE;

    STDMETHOD(put_OffsetDegree) (THIS_
                  int    Offset      /* [in] */    // Change to this Offset
              ) PURE;

    STDMETHOD(get_TimePercent) (THIS_
                  int    *Time        /* [out] */    // Change to this Time
              ) PURE;
    
    STDMETHOD(put_TimePercent) (THIS_
                  int    Time         /* [in] */    // Change to this Time
              ) PURE;

    STDMETHOD(get_Offset) (THIS_
                  int    *Offset1,    /* [out] */    // Change to this Offset
                  int    *Offset2     /* [out] */    // Change to this Offset
              ) PURE;

    STDMETHOD(put_Offset) (THIS_
                  int    Offset1,     /* [in] */    // Change to this Offset
                  int    Offset2      /* [in] */    // Change to this Offset
              ) PURE;

    STDMETHOD(get_Amplitude2) (THIS_
                  int *Amplitude      /* [out] */   // the current Amplitude2
             ) PURE;

    STDMETHOD(put_Amplitude2) (THIS_
                  int    Amplitude    /* [in] */    // Change to this Amplitude2
              ) PURE;

    STDMETHOD(get_Correlated) (THIS_
                  int   *Correlated    /* [in] */    // Change to this Amplitude2
              ) PURE;

    STDMETHOD(put_Correlated) (THIS_
                  int    Correlated    /* [in] */    // Change to this Amplitude2
              ) PURE;
