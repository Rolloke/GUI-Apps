================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : VideteCheckDisk Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese VideteCheckDisk-Anwendung erstellt. 
...
Ihre VideteCheckDisk-Anwendung bilden.

VideteCheckDisk.vcproj
...
res\VideteCheckDisk.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
    Symbol wird durch die Haupt-Ressourcendatei VideteCheckDisk.rc eingebunden.

res\VideteCheckDisk.rc2
...
VideteCheckDiskDlg.h, VideteCheckDiskDlg.cpp - das Dialogfeld
    Diese Dateien enthalten die Klasse CVideteCheckDiskDlg. Diese Klasse legt das
    Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
    felds befindet sich in VideteCheckDisk.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
    ...
    VideteCheckDisk.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
