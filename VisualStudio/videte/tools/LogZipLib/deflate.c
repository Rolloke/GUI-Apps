...
//**************************************************************
// GF pragma warning [disabled:4244]
// conversion from 'int' to 'ush', possible loss of data
 ...
 */
local int read_buf(z_stream *strm,
                   charf *buf,
                   unsigned size)
{
 ...
 */
local int deflate_fast(deflate_state *s,
                       int flush)
{
 ...
 */
local int deflate_slow(deflate_state *s,
                       int flush)
{
//  IPos hash_head; /* head of the hash chain */
    IPos hash_head = NIL; /* head of the hash chain */
