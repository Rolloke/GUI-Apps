================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : MPEG4Play2 Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese MPEG4Play2-Anwendung erstellt. 
...
Ihre MPEG4Play2-Anwendung bilden.
...
res\MPEG4Play2.ico
    ...
    Symbol wird durch die Haupt-Ressourcendatei MPEG4Play2.rc eingebunden.
...
MPEG4Play2Doc.h, MPEG4Play2Doc.cpp - das Dokument
    Diese Dateien enthalten die Klasse CMPEG4Play2Doc.  Bearbeiten Sie diese Dateien,
    um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
    Dateien zu implementieren (mit CMPEG4Play2Doc::Serialize).
MPEG4Play2View.h, MPEG4Play2View.cpp - die Ansicht des Dokuments
    Diese Dateien enthalten die Klasse CMPEG4Play2View.
    CMPEG4Play2View-Objekte werden verwendet, um CMPEG4Play2Doc-Objekte anzuzeigen.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    ...
    MPEG4Play2.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
