================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : ConfigExport Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese ConfigExport-Anwendung erstellt. 
...
Ihre ConfigExport-Anwendung bilden.
...
res\ConfigExport.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
    Symbol wird durch die Haupt-Ressourcendatei ConfigExport.rc eingebunden.

res\ConfigExport.rc2
...
ConfigExportDlg.h, ConfigExportDlg.cpp - das Dialogfeld
    Diese Dateien enthalten die Klasse CConfigExportDlg. Diese Klasse legt das
    Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
    felds befindet sich in ConfigExport.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
    ...
    ConfigExport.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
