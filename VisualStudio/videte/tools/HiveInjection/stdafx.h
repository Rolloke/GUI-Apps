...
#include <afxmt.h>			// MFC-Unterstützung für allgemeine Windows-Steuerelemente

#include <wkclasses\WK_util.h>
#include <wkclasses\WK_Trace.h>
#include <wkclasses\wk_profile.h>		// CWK_Profile wird NICHT verwendet. Nur die #defines
