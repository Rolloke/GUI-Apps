...
class DECLSPEC_UUID("137F19E2-B13B-46BF-8294-37714C05AAAF") SmartDebugLib;
...
#if _MSC_VER <= 1310
#define _itow_s(a1, a2, a3, a4) _itow(a1, a2, a4)
#define swprintf_s(a1, a2, a3, a4) swprintf(a1, a3, a4)
#define wcscat_s(a1, a2, a3) wcscat(a1, a3)
#define vsprintf_s _vsnprintf
#define wcscpy_s(a1, a2, a3) wcscpy(a1, a3)
#endif