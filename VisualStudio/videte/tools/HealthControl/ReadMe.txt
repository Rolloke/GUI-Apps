================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : HealthControl Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese HealthControl-Anwendung erstellt. 
...
Ihre HealthControl-Anwendung bilden.

HealthControl.vcproj
...
res\HealthControl.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
    Symbol wird durch die Haupt-Ressourcendatei HealthControl.rc eingebunden.

res\HealthControl.rc2
...
HealthControlDlg.h, HealthControlDlg.cpp - das Dialogfeld
    Diese Dateien enthalten die Klasse CHealthControlDlg. Diese Klasse legt das
    Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
    felds befindet sich in HealthControl.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
    ...
    HealthControl.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
