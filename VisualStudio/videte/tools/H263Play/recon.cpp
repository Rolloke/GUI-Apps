// recon.cpp, motion compensation routines for tmndecode (H.263 decoder)

#include "stdafx.h"
#include "H263Decoder.h"
#include "tables.h"

void CH263Decoder::reconstruct(int bx,int by,int P,int bdx,int bdy)
{
...
void CH263Decoder::recon_comp(unsigned char *src,
					   unsigned char *dst,
					   int lx, int lx2,
					   int w, int h,
					   int x,int y,
...
void CH263Decoder::rec(unsigned char *s,unsigned char *d,int lx,int lx2,int h)
{
	int j;
...
void CH263Decoder::recc(unsigned char *s,unsigned char *d,int lx,int lx2,int h)
{
	int j;
...
void CH263Decoder::reco(unsigned char *s,
				 int* d,
				 int lx,int lx2,int addflag,int c,int xa,int xb,int ya,int yb)
{
	int i,j;
	int *om;
...
void CH263Decoder::rech(unsigned char *s,unsigned char *d,int lx,int lx2,int h)
{
	unsigned char *dp,*sp;
	int j;
	unsigned int s1,s2;
...
void CH263Decoder::rechc(unsigned char *s,unsigned char *d,int lx,int lx2,int h)
{
	unsigned char *dp,*sp;
	int j;
	unsigned int s1,s2;
...
void CH263Decoder::recho(unsigned char *s,int *d,
				  int lx,int lx2,int addflag,int c,int xa,int xb,int ya,int yb)
{
	int *dp,*om;
	unsigned char *sp;
...
void CH263Decoder::recv(unsigned char *s,unsigned char *d,int lx,int lx2,int h)
{
...
void CH263Decoder::recvc(unsigned char *s,unsigned char *d,int lx,int lx2,int h)
{
	unsigned char *dp,*sp,*sp2;
	int j;
...
void CH263Decoder::recvo(unsigned char *s,int *d,
				  int lx,int lx2,int addflag,int c,int xa,int xb,int ya,int yb)
{
	int *dp,*om;
...
void CH263Decoder::rec4(unsigned char *s,unsigned char *d,int lx,int lx2,int h)
{
	unsigned char *dp,*sp,*sp2;
	int j;
...
void CH263Decoder::rec4c(unsigned char *s,unsigned char *d,int lx,int lx2,int h)
{
	unsigned char *dp,*sp,*sp2;
	int j;
	unsigned int s1,s2,s3,s4;
...
void CH263Decoder::rec4o(unsigned char *s,int *d,
				  int lx,int lx2,int addflag,int c,int xa,int xb,int ya,int yb)
{
	int *dp,*om;
	unsigned char *sp,*sp2;
...
void CH263Decoder::recon_comp_obmc(unsigned char* src,
							unsigned char* dst,
