================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : NeroShrink Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese NeroShrink-Anwendung erstellt. 
...
Ihre NeroShrink-Anwendung bilden.
...
res\NeroShrink.ico
    ...
    Symbol wird durch die Haupt-Ressourcendatei NeroShrink.rc eingebunden.
...
NeroShrinkDlg.h, NeroShrinkDlg.cpp - das Dialogfeld
    Diese Dateien enthalten die Klasse CNeroShrinkDlg. Diese Klasse legt das
    Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
    felds befindet sich in NeroShrink.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
    ...
    NeroShrink.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
