...
///////////////////////////////////////////////////////////////////////
	...
	m_pMCIDevice = new CMCIDevice();
	m_pMCIDevice->SetMainWnd(this);



	m_pMCIDevice->OpenCdromDevice("F:");

	m_pMCIDevice->OpenCDCaddy();
while(1)
{
	m_pMCIDevice->CloseCDCaddy();
}
error:
...
void CMciDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
