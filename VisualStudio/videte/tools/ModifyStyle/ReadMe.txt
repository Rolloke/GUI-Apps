========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : ModifyStyle
========================================================================


Diese ModifyStyle-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre ModifyStyle-Anwendung bilden.
...
ModifyStyle.h
	...
	Anwendungsklasse CModifyStyleApp.
...
res\ModifyStyle.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei ModifyStyle.rc eingebunden.
...
ModifyStyleDlg.h, ModifyStyleDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CModifyStyleDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in ModifyStyle.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	ModifyStyle.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
