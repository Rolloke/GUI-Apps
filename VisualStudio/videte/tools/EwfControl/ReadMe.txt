================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : EwfControl Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese EwfControl-Anwendung erstellt. 
...
Ihre EwfControl-Anwendung bilden.
...
res\EwfControl.ico
    ...
    Symbol wird durch die Haupt-Ressourcendatei EwfControl.rc eingebunden.
...
EwfControlDlg.h, EwfControlDlg.cpp - das Dialogfeld
    Diese Dateien enthalten die Klasse CEwfControlDlg. Diese Klasse legt das
    Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
    felds befindet sich in EwfControl.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
    ...
    EwfControl.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
