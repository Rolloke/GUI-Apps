========================================================================
                    CUSTOM APPWIZARD: WKAppWizard
========================================================================


AppWizard has created a WKAppWizard DLL for you.  This DLL is the starting point
...
you build WKAppWizard.awx, it will automatically be copied to your Template
...
WKAppWizard.mak
    ...
    nmake /f WKAppWizard.mak CFG="Win32 Debug".

    To build a release version of the program, type
    nmake /f WKAppWizard.mak CFG="Win32 Release".
...
WKAppWizardAw.h, WKAppWizardAw.cpp - the CCustomAppWiz class
    These files contain your CCustomAppWiz-derived class,
    CWKAppWizardAppWiz.  This class contains virtual member functions which
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into WKAppWizard.rc.  Be
...
StdAfx.h, StdAfx.cpp
    ...
    named WKAppWizard.pch and a precompiled types file named StdAfx.obj.
