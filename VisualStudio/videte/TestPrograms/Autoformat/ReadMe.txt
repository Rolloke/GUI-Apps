================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : Autoformat Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese Autoformat-Anwendung erstellt. 
...
Ihre Autoformat-Anwendung bilden.
...
res\Autoformat.ico
    ...
    Symbol wird durch die Haupt-Ressourcendatei Autoformat.rc eingebunden.
...
AutoformatDlg.h, AutoformatDlg.cpp - das Dialogfeld
    Diese Dateien enthalten die Klasse CAutoformatDlg. Diese Klasse legt das
    Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
    felds befindet sich in Autoformat.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
    ...
    Autoformat.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
