================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : TestCIPCPerformance Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese TestCIPCPerformance-Anwendung erstellt. 
...
Ihre TestCIPCPerformance-Anwendung bilden.

TestCIPCPerformance.vcproj
...
TestCIPCPerformance.h
    ...
    CTestCIPCPerformanceApp-Anwendungsklasse.

TestCIPCPerformance.cpp
    Hierbei handelt es sich um die Haupt-Quellcodedatei der Anwendung. Diese enthält die
    Anwendungsklasse CTestCIPCPerformanceApp.

TestCIPCPerformance.rc
...
res\TestCIPCPerformance.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
    Symbol wird durch die Haupt-Ressourcendatei TestCIPCPerformance.rc eingebunden.

res\TestCIPCPerformance.rc2
...
TestCIPCPerformanceDlg.h, TestCIPCPerformanceDlg.cpp - das Dialogfeld
    Diese Dateien enthalten die Klasse CTestCIPCPerformanceDlg. Diese Klasse legt das
    Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
    felds befindet sich in TestCIPCPerformance.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
    ...
    TestCIPCPerformance.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
