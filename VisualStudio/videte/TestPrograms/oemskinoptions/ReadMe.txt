================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : OEMSkinOptions Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese OEMSkinOptions-Anwendung erstellt. 
...
Ihre OEMSkinOptions-Anwendung bilden.

OEMSkinOptions.vcproj
...
res\OEMSkinOptions.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
    Symbol wird durch die Haupt-Ressourcendatei OEMSkinOptions.rc eingebunden.

res\OEMSkinOptions.rc2
...
OEMSkinOptionsDlg.h, OEMSkinOptionsDlg.cpp - das Dialogfeld
    Diese Dateien enthalten die Klasse COEMSkinOptionsDlg. Diese Klasse legt das
    Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
    felds befindet sich in OEMSkinOptions.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
    ...
    OEMSkinOptions.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
