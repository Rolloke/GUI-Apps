================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : DetermineIPAddress Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese DetermineIPAddress-Anwendung erstellt. 
...
Ihre DetermineIPAddress-Anwendung bilden.

DetermineIPAddress.vcproj
...
DetermineIPAddress.h
    ...
    CDetermineIPAddressApp-Anwendungsklasse.

DetermineIPAddress.cpp
    Hierbei handelt es sich um die Haupt-Quellcodedatei der Anwendung. Diese enthält die
    Anwendungsklasse CDetermineIPAddressApp.

DetermineIPAddress.rc
...
res\DetermineIPAddress.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
    Symbol wird durch die Haupt-Ressourcendatei DetermineIPAddress.rc eingebunden.

res\DetermineIPAddress.rc2
...
DetermineIPAddressDlg.h, DetermineIPAddressDlg.cpp - das Dialogfeld
    Diese Dateien enthalten die Klasse CDetermineIPAddressDlg. Diese Klasse legt das
    Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
    felds befindet sich in DetermineIPAddress.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
    ...
    DetermineIPAddress.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
