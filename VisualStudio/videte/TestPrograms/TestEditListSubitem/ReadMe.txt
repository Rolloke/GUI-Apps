================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : TestEditListSubitem Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese TestEditListSubitem-Anwendung erstellt. 
...
Ihre TestEditListSubitem-Anwendung bilden.

TestEditListSubitem.vcproj
...
TestEditListSubitem.h
    ...
    CTestEditListSubitemApp-Anwendungsklasse.

TestEditListSubitem.cpp
    Hierbei handelt es sich um die Haupt-Quellcodedatei der Anwendung. Diese enthält die
    Anwendungsklasse CTestEditListSubitemApp.

TestEditListSubitem.rc
...
res\TestEditListSubitem.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
    Symbol wird durch die Haupt-Ressourcendatei TestEditListSubitem.rc eingebunden.

res\TestEditListSubitem.rc2
...
TestEditListSubitemDlg.h, TestEditListSubitemDlg.cpp - das Dialogfeld
    Diese Dateien enthalten die Klasse CTestEditListSubitemDlg. Diese Klasse legt das
    Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
    felds befindet sich in TestEditListSubitem.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
    ...
    TestEditListSubitem.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
