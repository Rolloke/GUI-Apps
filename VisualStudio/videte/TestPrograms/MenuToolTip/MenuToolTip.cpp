// MenuToolTip.cpp : Definiert das Klassenverhalten für die Anwendung.
//
...
BEGIN_MESSAGE_MAP(CMenuToolTipApp, CWinApp)
...
// CMenuToolTipApp-Erstellung

CMenuToolTipApp::CMenuToolTipApp()
{
...
// Das einzige CMenuToolTipApp-Objekt

CMenuToolTipApp theApp;

// CMenuToolTipApp Initialisierung

BOOL CMenuToolTipApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMenuToolTipDoc),
		RUNTIME_CLASS(CMainFrame),       // Haupt-SDI-Rahmenfenster
		RUNTIME_CLASS(CMenuToolTipView));
	if (!pDocTemplate)
		return FALSE;
...
void CMenuToolTipApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
// CMenuToolTipApp Meldungshandler
