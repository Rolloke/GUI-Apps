================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : TestJoystick Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese TestJoystick-Anwendung erstellt. 
...
Ihre TestJoystick-Anwendung bilden.
...
res\TestJoystick.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
    Symbol wird durch die Haupt-Ressourcendatei TestJoystick.rc eingebunden.

res\TestJoystick.rc2
...
TestJoystickDlg.h, TestJoystickDlg.cpp - das Dialogfeld
    Diese Dateien enthalten die Klasse CTestJoystickDlg. Diese Klasse legt das
    Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
    felds befindet sich in TestJoystick.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
    ...
    TestJoystick.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
