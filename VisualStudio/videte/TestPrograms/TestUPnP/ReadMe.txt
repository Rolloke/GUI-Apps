================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : TestUPnP Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese TestUPnP-Anwendung erstellt. 
...
Ihre TestUPnP-Anwendung bilden.
...
res\TestUPnP.ico
    ...
    Symbol wird durch die Haupt-Ressourcendatei TestUPnP.rc eingebunden.
...
TestUPnPDlg.h, TestUPnPDlg.cpp - das Dialogfeld
    Diese Dateien enthalten die Klasse CTestUPnPDlg. Diese Klasse legt das
    Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
    felds befindet sich in TestUPnP.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
    ...
    TestUPnP.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
