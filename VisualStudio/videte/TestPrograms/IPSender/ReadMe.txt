================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : IPSender Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese IPSender-Anwendung erstellt. 
...
Ihre IPSender-Anwendung bilden.
...
res\IPSender.ico
    ...
    Symbol wird durch die Haupt-Ressourcendatei IPSender.rc eingebunden.
...
IPSenderDlg.h, IPSenderDlg.cpp - das Dialogfeld
    Diese Dateien enthalten die Klasse CIPSenderDlg. Diese Klasse legt das
    Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
    felds befindet sich in IPSender.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
    ...
    IPSender.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
