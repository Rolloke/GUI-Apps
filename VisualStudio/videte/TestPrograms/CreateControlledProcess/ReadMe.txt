================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : CreateControlledProcess Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese CreateControlledProcess-Anwendung erstellt. 
...
Ihre CreateControlledProcess-Anwendung bilden.

CreateControlledProcess.vcproj
...
CreateControlledProcess.h
    ...
    CCreateControlledProcessApp-Anwendungsklasse.

CreateControlledProcess.cpp
    Hierbei handelt es sich um die Haupt-Quellcodedatei der Anwendung. Diese enthält die
    Anwendungsklasse CCreateControlledProcessApp.

CreateControlledProcess.rc
...
res\CreateControlledProcess.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
    Symbol wird durch die Haupt-Ressourcendatei CreateControlledProcess.rc eingebunden.

res\CreateControlledProcess.rc2
...
CreateControlledProcessDlg.h, CreateControlledProcessDlg.cpp - das Dialogfeld
    Diese Dateien enthalten die Klasse CCreateControlledProcessDlg. Diese Klasse legt das
    Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
    felds befindet sich in CreateControlledProcess.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
    ...
    CreateControlledProcess.pch und eine vorkompilierte Typdatei mit der Bezeichnung 
    StdAfx.obj erstellt.
