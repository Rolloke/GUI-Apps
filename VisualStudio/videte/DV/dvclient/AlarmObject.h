...
public:
	...
	CString GetFormatStringTimeFirst();
...
//////////////////////////////////////////////////////////////////////
WK_PTR_LIST_CS(CAlarmObjectListBase, CAlarmObject*, CAlarmObjectListBaseCS);
//////////////////////////////////////////////////////////////////////
class CAlarmObjectListCS : public CAlarmObjectListBaseCS
{
};
