...
public:
	...
	virtual BOOL PictureData(const CIPCPictureRecord &pict,DWORD dwX, DWORD dwY);
	virtual BOOL SetMDValues(WORD wX, WORD wY, BOOL bForce=FALSE);
...
private:
	CJpeg*				m_pJpeg;
	Resolution			m_resCurrent;

	WORD				m_wMD_X;
	WORD				m_wMD_Y;
	DWORD				m_dwLastMD_TC;
	BOOL				m_bMD;
	BOOL				m_bAllowDeinterlacing;
