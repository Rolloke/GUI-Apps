...
: CWK_Thread(_T("PlayRealTime"),NULL)
{
	...
	//trace ThreadLog in Logfile after 12 ours
...
void CPlayRealTime::Wait()
{
	...
	PostMessage(m_hPlayWindow, WM_PLAY_REALTIME, 0, 0);
	m_bExtraTimeToWait = FALSE;
}
...
//////////////////////////////////////////////////////////////////////
void CPlayRealTime::SetHandlePlayWindow(HWND hPlayWindow)
{
	m_hPlayWindow = hPlayWindow;
}
//////////////////////////////////////////////////////////////////////
