...
BOOL CTape::Move(CTape& source)
{
	...
	CAutoCritSec acsS(&source.m_cs, _T("S12"), DVS_TIMEOUT);
	CAutoCritSec acs(&m_cs, _T(__FUNCTION__), DVS_TIMEOUT);
...
BOOL CTape::Backup(CBackup& b)
{
	...
	CAutoCritSec acs1(&m_cs, _T(__FUNCTION__), DVS_TIMEOUT);
	...
	CAutoCritSec acs2(&m_cs, _T(__FUNCTION__) _T("B"), DVS_TIMEOUT);
	m_bLockedByBackup = FALSE;
	acs2.Unlock();
