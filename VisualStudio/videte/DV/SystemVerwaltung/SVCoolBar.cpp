...
BOOL CSVCoolBar::OnCreateBands()
{
	...
	m_wndToolBar.SetButtonInfo(i++, ID_FILE_SAVE, TBSTYLE_BUTTON, b++);
	m_wndToolBar.SetButtonInfo(i++, ID_EDIT_CANCEL, TBSTYLE_BUTTON, b++);
	m_wndToolBar.SetButtonInfo(i++, ID_EDIT_SERVERINIT, TBSTYLE_BUTTON, b++);
	m_wndToolBar.SetButtonInfo(i++, ID_SEPARATOR, TBBS_SEPARATOR, 10/*Pixel Width*/);
	m_wndToolBar.SetButtonInfo(i++, ID_EDIT_NEW, TBSTYLE_BUTTON, b++);
	m_wndToolBar.SetButtonInfo(i++, ID_EDIT_DELETE, TBSTYLE_BUTTON, b++);
	m_wndToolBar.SetButtonInfo(i++, ID_SEPARATOR, TBBS_SEPARATOR, 10/*Pixel Width*/);
