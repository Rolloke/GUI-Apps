...
//////////////////////////////////////////////////////////////////////
BOOL CDVStorageApp::HandleFileException(DWORD dwLastError, LPCTSTR sFilename)
{
	BOOL bReturn = TRUE;
	switch ((short)HIWORD(dwLastError))
	{
	...
	switch (LOWORD(dwLastError))
	{
		case ERROR_FILE_NOT_FOUND:
		case ERROR_PATH_NOT_FOUND:
		case ERROR_BAD_PATHNAME:
		case ERROR_INVALID_DRIVE:
			AfxThrowFileException(CFileException::badPath, dwLastError, sFilename);
			break;
