								 ...
								 DWORD& dwNrOfRecords)
{
	...
	CAutoCritSec csCollection(&m_csCollection, _T("C25"), DVS_TIMEOUT);
...
{
	BOOL bRet = TRUE;
	CAutoCritSec csCollection(&m_csCollection, _T("C24"), DVS_TIMEOUT);
	...
	if (bRet)
	{
		...
		if (!IsPreAlarm())
		{
			...
			if (!bSuspect)
			{
				...
				{
					CAutoCritSec csArchives(&theApp.m_Archives.m_cs);
...
void CCollection::MoveTapes(CCollection* pCollection)
{
	...
	CAutoCritSec csCollection(&pCollection->m_cs, _T("C23"), DVS_TIMEOUT);
...
//////////////////////////////////////////////////////////////////////////////
void CCollection::Lock(const CString& sName)
{
	...
	{
		WK_TRACE(_T("%s lock in %d ms Thread %08lx, Archiv Nr %04hx\n"),
			sName,dwTick2,GetCurrentThreadId(),GetNr());
	}
}
//////////////////////////////////////////////////////////////////////////////
void CCollection::Unlock()
{
	m_csCollection.Unlock();
}
//////////////////////////////////////////////////////////////////////////////
void CCollection::CBLock()
{
	m_csCB.Lock();
}
//////////////////////////////////////////////////////////////////////////////
void CCollection::CBUnlock()
{
	m_csCB.Unlock();
}
//////////////////////////////////////////////////////////////////////////////
