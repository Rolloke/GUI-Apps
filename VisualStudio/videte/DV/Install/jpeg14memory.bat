...
$DEST_DIR="d:\\install\\jpegmemorypatch";
...
# oem DTS is Original
print "$WISE_CMD /c \"$WISE_DIR\\jpeg14memory.wse\" \n";
`$WISE_CMD /c \"$WISE_DIR\\jpeg14memory.wse\" `;
...
{ 
	...
	print "v:\\bin\\tools\\MakeUpdateDisk.exe $DEST_DIR $oemNumber 364\n";
	`v:\\bin\\tools\\MakeUpdateDisk.exe $DEST_DIR $oemNumber 364`;
