...
# oem DTS is Original
print "$WISE_CMD /c \"$WISE_DIR\\vdr16light.wse\" \n";
`$WISE_CMD /c \"$WISE_DIR\\vdr16light.wse\" `;
...
{ 
	...
	print "v:\\bin\\tools\\MakeUpdateDisk.exe $DEST_DIR $oemNumber 601\n";
	`v:\\bin\\tools\\MakeUpdateDisk.exe $DEST_DIR $oemNumber 601`;
