...
$DEST_DIR="p:\\programme\\intern\\Dts\\Patches\\ComPatch";
...
# oem DTS is Original
print "$WISE_CMD /c \"$WISE_DIR\\com_sp2.wse\" \n";
`$WISE_CMD /c \"$WISE_DIR\\com_sp2.wse\" `;

&DoConfiguration("all_oem",-1);
...
{ 
	...
	print "v:\\bin\\tools\\MakeUpdateDisk.exe $DEST_DIR $oemNumber 0\n";
	`v:\\bin\\tools\\MakeUpdateDisk.exe $DEST_DIR $oemNumber 0`;
