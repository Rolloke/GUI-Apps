...
$DEST_DIR="p:\\programme\\intern\\dts\\patches\\838a";
...
# oem DTS is Original
print "$WISE_CMD /c \"$WISE_DIR\\838a.wse\" \n";
`$WISE_CMD /c \"$WISE_DIR\\838a.wse\" `;

&DoConfiguration("common",-1);
...
{ 
	...
	print "v:\\bin\\tools\\MakeUpdateDisk.exe $DEST_DIR $oemNumber 838\n";
	`v:\\bin\\tools\\MakeUpdateDisk.exe $DEST_DIR $oemNumber 838`;
