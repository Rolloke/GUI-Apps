...
$DEST_DIR="D:\\Install\\Patches\\DTS\\612_Nld";
...
# oem DTS is Original
print "$WISE_CMD /c \"$WISE_DIR\\612_Nld.wse\" \n";
`$WISE_CMD /c \"$WISE_DIR\\612_Nld.wse\" `;
...
{ 
	...
	print "v:\\bin\\tools\\MakeUpdateDisk.exe $DEST_DIR $oemNumber 612\n";
	`v:\\bin\\tools\\MakeUpdateDisk.exe $DEST_DIR $oemNumber 612`;
