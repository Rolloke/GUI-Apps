...
class CLivePicture : public CStatic
{
...
private:
	...
	//of type 'relay'
	CIPCOutputOCX*	m_pCIPCOutputOCX;//pointer to OutputSample which
	//controls the output connection
	//to the connected server
	CIPCInputOCX*	m_pCIPCInputSample;	//pointer to InputSample which
