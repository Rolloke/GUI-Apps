...
struct 
{
	...
	LPTSTR sFormat;
} static const StrucFormats[] = 
{ 
	{WAVE_FORMAT_UNKNOWN,              _T("Unknown")},          // Microsoft Corporation
	{WAVE_FORMAT_PCM,                  _T("PCM")},              // Microsoft Corporation
	{WAVE_FORMAT_ADPCM,                _T("ADPCM")},            // Microsoft Corporation
	{WAVE_FORMAT_IEEE_FLOAT,           _T("IEEE Float")},       // IEEE754: range (+1, -1] 
	                                                            // 32-bit/64-bit format as defined by MSVC++ float/double type
	{WAVE_FORMAT_IBM_CVSD,             _T("IBM CVSD")},         // IBM Corporation
	{WAVE_FORMAT_ALAW,                 _T("CCITT A-Law")},      // Microsoft Corporation
	{WAVE_FORMAT_MULAW,                _T("CCITT u-Law")},      // Microsoft Corporation
	{WAVE_FORMAT_OKI_ADPCM,            _T("OKI ADPCM")},        // OKI
	{WAVE_FORMAT_DVI_ADPCM,            _T("DVI ADPCM")},        // Intel Corporation
	{WAVE_FORMAT_IMA_ADPCM,            _T("IMA ADPCM")},        // Intel Corporation
	{WAVE_FORMAT_MEDIASPACE_ADPCM,     _T("Mediaspace ADPCM")}, // Videologic
	{WAVE_FORMAT_SIERRA_ADPCM,         _T("Sierra ADPCM")},     // Sierra Semiconductor Corp
	{WAVE_FORMAT_G723_ADPCM,           _T("G723 ADPCM")},	      // Antex Electronics Corporation
	{WAVE_FORMAT_DIGISTD,              _T("DIGI STD")},         // DSP Solutions, Inc.
	{WAVE_FORMAT_DIGIFIX,              _T("DIGI FIX")},         // DSP Solutions, Inc.
	{WAVE_FORMAT_DIALOGIC_OKI_ADPCM,   _T("Dialogic OKI ADPCM")},// Dialogic Corporation
	{WAVE_FORMAT_MEDIAVISION_ADPCM,    _T("Mediavision ADPCM")}, // Media Vision, Inc.
	{WAVE_FORMAT_YAMAHA_ADPCM,         _T("YAMAHA ADPCM")},     // Yamaha Corporation of America
	{WAVE_FORMAT_SONARC,               _T("Sonarc Speech Comp")},// Speech Compression
	{WAVE_FORMAT_DSPGROUP_TRUESPEECH,  _T("DSP Group Truespeech")},// DSP Group, Inc
	{WAVE_FORMAT_ECHOSC1,              _T("Echo SC1 ")},        // Echo Speech Corporation
	{WAVE_FORMAT_AUDIOFILE_AF36,       _T("Audiofile AF36")},   // 
	{WAVE_FORMAT_APTX,                 _T("APTX")},             // Audio Processing Technology
	{WAVE_FORMAT_AUDIOFILE_AF10,       _T("Audiofile AF10")},   // 
	{WAVE_FORMAT_DOLBY_AC2,            _T("Dolby AC2")},        // Dolby Laboratories
	{WAVE_FORMAT_GSM610,               _T("GSM 6.10")},         // Microsoft Corporation
	{WAVE_FORMAT_MSNAUDIO,             _T("MSN Audio")},        // Microsoft Corporation
	{WAVE_FORMAT_ANTEX_ADPCME,         _T("Antex ADPCME")},     // Antex Electronics Corporation
	{WAVE_FORMAT_CONTROL_RES_VQLPC,    _T("Control Res VQLPC")},// Control Resources Limited
	{WAVE_FORMAT_DIGIREAL,             _T("DIGI REAL")},        // DSP Solutions, Inc.
	{WAVE_FORMAT_DIGIADPCM,            _T("DIGI ADPCM")},       // DSP Solutions, Inc.
	{WAVE_FORMAT_CONTROL_RES_CR10,     _T("Control Res CR10")}, // Control Resources Limited
	{WAVE_FORMAT_NMS_VBXADPCM,         _T("NMS VBXADPCM")},     // Natural MicroSystems
	{WAVE_FORMAT_CS_IMAADPCM,          _T("CS IMA ADPCM")},     // Crystal Semiconductor IMA ADPCM
	{WAVE_FORMAT_ECHOSC3,              _T("Echo SC3")},         // Echo Speech Corporation
	...
	{WAVE_FORMAT_G721_ADPCM,           _T("G721 ADPCM")},       // Antex Electronics Corporation
	{WAVE_FORMAT_G728_CELP,            _T("G728 CELP")},        // Antex Electronics Corporation
	{WAVE_FORMAT_MPEG,                 _T("MPEG")},             // Microsoft Corporation
	{WAVE_FORMAT_MPEGLAYER3,           _T("MPEG Layer 3")},     // ISO/MPEG Layer3
	{WAVE_FORMAT_CIRRUS,               _T("Cirrus Logic")},     // Cirrus Logic 
	{WAVE_FORMAT_ESPCM,                _T("ESS PCM")},          // ESS Technology
	{WAVE_FORMAT_VOXWARE,              _T("Voxware")},          // Voxware Inc
#if _MFC_VER == 0x0600
	{WAVEFORMAT_CANOPUS_ATRAC,         _T("Canopus Atrac")},    // Canopus, co., Ltd.
#elif _MFC_VER >= 0x0700
	{WAVE_FORMAT_CANOPUS_ATRAC,        _T("Canopus Atrac")},    // Canopus, co., Ltd.
#endif
	{WAVE_FORMAT_G726_ADPCM,           _T("G726 ADPCM")},       // APICOM
	{WAVE_FORMAT_G722_ADPCM,           _T("G722 ADPCM")},       // APICOM
#if _MFC_VER == 0x0600
	{WAVE_FORMAT_DSAT,                 _T("DSAT")},             // Microsoft Corporation
#endif
	{WAVE_FORMAT_DSAT_DISPLAY,         _T("DSAT DISPLAY")},     // Microsoft Corporation
	{WAVE_FORMAT_SOFTSOUND,            _T("SOFTSOUND")},        // Softsound, Ltd.
	{WAVE_FORMAT_RHETOREX_ADPCM,       _T("Rhetorex ADPCM")},   // Rhetorex Inc
	{WAVE_FORMAT_CREATIVE_ADPCM,       _T("Creative ADPCM")},   // Creative Labs, Inc
	{WAVE_FORMAT_CREATIVE_FASTSPEECH8, _T("Creative FastSpeech8")},// Creative Labs, Inc
	{WAVE_FORMAT_CREATIVE_FASTSPEECH10,_T("Creative FastSpeech1")},// Creative Labs, Inc
	{WAVE_FORMAT_QUARTERDECK,          _T("Quarterdeck")},      // Quarterdeck Corporation
	{WAVE_FORMAT_FM_TOWNS_SND,         _T("FM Towns SND")},     // Fujitsu Corp. 
	{WAVE_FORMAT_BTV_DIGITAL,          _T("BTV Digital")},      // Brooktree Corporation
	{WAVE_FORMAT_OLIGSM,               _T("OLI GSM")},          // Ing C. Olivetti & C., S.p.A.
	{WAVE_FORMAT_OLIADPCM,             _T("OLI ADPCM")},        // Ing C. Olivetti & C., S.p.A.
	{WAVE_FORMAT_OLICELP,              _T("OLI CELP")},         // Ing C. Olivetti & C., S.p.A.
	{WAVE_FORMAT_OLISBC,               _T("OLI SBC")},          // Ing C. Olivetti & C., S.p.A.
	{WAVE_FORMAT_OLIOPR,               _T("OLI OPR")},          // Ing C. Olivetti & C., S.p.A.
	{WAVE_FORMAT_LH_CODEC,             _T("LH CODEC")},         // Lernout & Hauspie
	{WAVE_FORMAT_NORRIS,               _T("Norris")},           // Norris Communications, Inc.
	{0xffff, NULL}
};


void GetGUIDString(CString& sString, GUID *pGUID, BOOL bFriendlyName)
{
	int i=0;
	BOOL bFound = FALSE;

	if (bFriendlyName < GET_FOURCC_NAME)
	{
	...
	if (!bFound) // If we got here, there was no match
	{
		if (   pGUID->Data2    == 0			// is it Wave
			 && pGUID->Data3    == 0x0010
			 && pGUID->Data4[0] == 0x80 
			 && pGUID->Data4[1] == 0x00 
			 && pGUID->Data4[2] == 0x00
			 ...
			 && pGUID->Data4[7] == 0x71)
		{
			for (int i=0; StrucFormats[i].sFormat != NULL; i++)
			{
				if (pGUID->Data1 == StrucFormats[i].wFormat)
				{
					bFound = TRUE;
					sString = StrucFormats[i].sFormat;
					break;
				}
			}
		}
		if (!bFound)
		{
			...
			char *psz=(char*)&dwFourCC;
			sString.Empty();
			for (i=3; i>=0; i--)
			{
				if      (IsBetween(psz[i], 'a', 'z')) sString += psz[i];
				else if (IsBetween(psz[i], 'A', 'Z')) sString += psz[i];
				else if (IsBetween(psz[i], '0', '9')) sString += psz[i];
			}
			if (sString.IsEmpty())
			{
				sString = TEXT("GUID_NULL\0");
			}
		}
	}
	if (bFriendlyName)
	{
		i = sString.Find(_T("_"));
		if (i != -1) sString = sString.Mid(i+1);
	}
}


void GetFormatString(CString& sFormat, DMO_MEDIA_TYPE *pType)
{
    int i=0;
    ...
    sFormat = TEXT("Format_None\0");
}


void GetTypeSubtypeString(CString& sCLSID, DMO_PARTIAL_MEDIATYPE& aList)
{
    HRESULT hr;
    ...
    sCLSID.Format(TEXT("%s\t%s"), strType, strSubtype);
}
