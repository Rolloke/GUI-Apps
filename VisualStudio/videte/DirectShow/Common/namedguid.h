...
#define GET_FOURCC_NAME 2
// Function prototypes
AFX_EXT_CLASS void GetGUIDString(CString& sString, GUID *pGUID, BOOL bFriendlyName=FALSE);
AFX_EXT_CLASS void GetFormatString(CString& sFormat, DMO_MEDIA_TYPE *pType);
AFX_EXT_CLASS void GetTypeSubtypeString(CString &sCLSID, DMO_PARTIAL_MEDIATYPE& aList);
