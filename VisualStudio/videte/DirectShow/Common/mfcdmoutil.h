...
// Function prototypes
//
AFX_EXT_CLASS HRESULT EnumDMOsToList(IEnumDMO *pEnumCat, CListBox *pList, CComboBox *pCombo, int& nFilters);
AFX_EXT_CLASS HRESULT AddDMOsToList(const GUID *clsid, CListBox *pList, CComboBox *pCombo, BOOL bIncludeKeyed);

AFX_EXT_CLASS void DisplayDMOTypeInfo(const GUID *pCLSID, 
