...
class CTeeInputPin : public CBaseInputPin, public IInfTee
{
...
public:
	...
	// IInfTee interface functions
   STDMETHODIMP EnableOutPin(int, BOOL);
   STDMETHODIMP IsOutPinEnabled(int, BOOL*);
   STDMETHODIMP SetDataCheckFunction(int, DATACHECK_FUNCTION, long);
...
class CTeeOutputPin : public CBaseOutputPin
{
    ...
    LONG m_cOurRef;                // We maintain reference counting
	 BOOL m_bActivated;
	 DATACHECK_FUNCTION m_pCheckFunc;
	 long m_lParam;
public:
