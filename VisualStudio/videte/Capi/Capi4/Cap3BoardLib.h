...
#		define DVRCAP_API  extern "C" __declspec(dllexport) 
#	else
...
// Callback Prototype
// *********************************************************************** 
typedef BOOL (CALLING_API *FUNC_ON_THREEDWORD)(DWORD A, DWORD B, DWORD C);
typedef BOOL (CALLING_API *FUNC_ON_TWODWORD)(DWORD A, DWORD B);
typedef BOOL (CALLING_API *FUNC_ON_ONEDWORD)(DWORD A);
...
DVRCAP_API BOOL CALLING_API Cap3QueryInfo(DWORD cmd, DWORD *Param0, DWORD *Param1, DWORD *Param2, DWORD *Param3);
