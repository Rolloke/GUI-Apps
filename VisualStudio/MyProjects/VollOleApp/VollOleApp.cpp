// VollOleApp.cpp : Legt das Klassenverhalten für die Anwendung fest.
//
...
BEGIN_MESSAGE_MAP(CVollOleAppApp, CWinApp)
	//{{AFX_MSG_MAP(CVollOleAppApp)
...
/////////////////////////////////////////////////////////////////////////////
// CVollOleAppApp Konstruktion

CVollOleAppApp::CVollOleAppApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// Das einzige CVollOleAppApp-Objekt

CVollOleAppApp theApp;
...
// {E1E8E840-3E20-11D4-B6EC-0000B458D891}
static const CLSID clsid =
{ 0xe1e8e840, 0x3e20, 0x11d4, { 0xb6, 0xec, 0x0, 0x0, 0xb4, 0x58, 0xd8, 0x91 } };

/////////////////////////////////////////////////////////////////////////////
// CVollOleAppApp Initialisierung

BOOL CVollOleAppApp::InitInstance()
{
	if (!AfxSocketInit())
	{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CVollOleAppDoc),
		RUNTIME_CLASS(CMainFrame),       // Haupt-SDI-Rahmenfenster
		RUNTIME_CLASS(CVollOleAppView));
...
void CVollOleAppApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
/////////////////////////////////////////////////////////////////////////////
// CVollOleAppApp-Nachrichtenbehandlungsroutinen

int CVollOleAppApp::ExitInstance() 
{
