...
public:
   ...
   char    *GetXUnit() {return m_pszUnitx;};
   void     SetYUnit(const char *);
   char    *GetYUnit() {return m_pszUnity;};
   void     SetLocusUnit(const char *);
   char    *GetLocusUnit() {return m_pszUnitLocus;};
...
/******************************************************************************
* Name       : SetDescription                                                 *
* Definition : void SetDescription(char *s);                                  *
* Zweck      : Setzt den Beschreibungstext für die Kurve.                     *
* Aufruf     : SetDescription(s)                                              *
* Parameter  :                                                                *
* s      (E) : Zeiger auf Beschreibungstext                          (char*)  *
* Funktionswert keiner                                                        *
******************************************************************************/
/******************************************************************************
* Name       : SetXUnit                                                       *
* Definition : void SetXUnit(char *s);                                        *
* Zweck      : Setzt den Text für die Einheit der X-Achse                     *
* Aufruf     : SetXUnit(s);                                                   *
* Parameter  :                                                                *
* s      (E) : Zeiger auf Text                                       (char*)  *
* Funktionswert keiner                                                        *
******************************************************************************/
/******************************************************************************
* Name       : SetYUnit                                                       *
* Definition : void SetYUnit(char *s);                                        *
