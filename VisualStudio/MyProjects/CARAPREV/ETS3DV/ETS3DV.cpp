// ETS3DV.cpp : Legt das Klassenverhalten für die Anwendung fest.
//
...
BEGIN_MESSAGE_MAP(CETS3DVApp, CWinApp)
	//{{AFX_MSG_MAP(CETS3DVApp)
...
/////////////////////////////////////////////////////////////////////////////
// CETS3DVApp Konstruktion

CETS3DVApp::CETS3DVApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// CETS3DVApp Initialisierung

BOOL CETS3DVApp::InitInstance()
{
	if (!AfxSocketInit())
	{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CETS3DVDoc),
		RUNTIME_CLASS(CMainFrame),       // Haupt-SDI-Rahmenfenster
		RUNTIME_CLASS(CETS3DVView));
...
/////////////////////////////////////////////////////////////////////////////
// CETS3DVApp-Nachrichtenbehandlungsroutinen
