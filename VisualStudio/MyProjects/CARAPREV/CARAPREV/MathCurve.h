...
public:
   ...
   bool        FFT(bool bT2F, CMathCurve *pmc=NULL);
   ...
   Complex     PolynomValue(double x, SCInterpolynom *pip);
	void        MultiplyUnit(TCHAR *pszUnit);
	void        DivideUnit(  TCHAR *pszUnit);
	void        SplitUnit(   TCHAR *pszUnit, TCHAR *pszAbove, TCHAR *pszUnder);
	bool        MultiplyUnitPart(TCHAR *pszPart, TCHAR* pszUnit);
	bool        DivideUnitPart(  TCHAR *pszPart, TCHAR* pszUnit);
