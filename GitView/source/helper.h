...
#define MAKE_NAME(ITEM) getSettingsName(#ITEM)

#define STORE_PTR(SETTING, ITEM, FUNC)  SETTING.setValue(MAKE_NAME(ITEM), ITEM->FUNC())
#define STORE_NP(SETTING, ITEM, FUNC)   SETTING.setValue(MAKE_NAME(ITEM), ITEM.FUNC())
#define STORE_STR(SETTING, ITEM)        SETTING.setValue(MAKE_NAME(ITEM), ITEM)
#define STORE_STR_IF(SETTING, ITEM) if (ITEM.size())    SETTING.setValue(MAKE_NAME(ITEM), ITEM);
#define STORE_STRFN(SETTING, ITEM, NAME, FUNC) SETTING.setValue(NAME, FUNC(ITEM))
#define STORE_STRF(SETTING, ITEM, FUNC) STORE_STRFN(SETTING, ITEM, MAKE_NAME(ITEM), FUNC)

#define LOAD_PTR(SETTING, ITEM, SET, GET, CONVERT)  ITEM->SET(SETTING.value(MAKE_NAME(ITEM), ITEM->GET()).CONVERT())
#define LOAD_NP(SETTING, ITEM, SET, GET, CONVERT)   ITEM.SET(SETTING.value(MAKE_NAME(ITEM), ITEM.GET()).CONVERT())
#define LOAD_STR(SETTING, ITEM, CONVERT)            ITEM=SETTING.value(MAKE_NAME(ITEM), ITEM).CONVERT()
...
#define LOAD_STRF(SETTING, ITEM, FUNC_OUT, FUNC_IN, CONVERT) ITEM = LOAD_STRFN(SETTING, ITEM, MAKE_NAME(ITEM), FUNC_OUT, FUNC_IN, CONVERT)
