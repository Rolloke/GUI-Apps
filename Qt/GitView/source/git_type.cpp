...
Cmd::Cmd()
{
    ...
    mContextMenuSourceTree      = { Add, ForceAddFileToGit, Unstage, Restore, Remove, Delete, MoveOrRename, CopyFileName, CopyFilePath, AddExternalFileOpenExt, DeleteExternalFileOpenExt, OpenFileExternally, Separator, ShowDifference, CallDiffTool, CallMergeTool, ShowShortStatus, ShowStatus, ShowInformation, Commit, StashPush, History, StashShow, Separator, ExpandTreeItems, CollapseTreeItems };
    ...
    mContextMenuBranchTree      = { BranchList, BranchListRemote, BranchListMerged, BranchListNotMerged, Separator, BranchShow, BranchHistory, BranchCheckout, BranchDelete, Separator, ExpandTreeItems, CollapseTreeItems, ShowHideTree, ClearTreeItems, DeleteTreeItems };
