...
*/
    ...
    public:
       ...
       */
        ...
        */
        void cross_product(const vectorX& v1, const vectorX& v2)
        {
            size_t n = v1.size();
            if (n == v2.size())
            {
        ...
        */
        friend vectorX cross_product(const vectorX& v1, const vectorX& v2)
        {
            vectorX<T> r;
        ...
        */
        friend T scalar_product(const vectorX& v1, const vectorX& v2)
        {
            if (v1.size() == v2.size())
            {
                T r = 0;
        ...
        */
        friend T Sin(const vectorX&v1, const vectorX&v2)              // Sinus des Winkels zwischen zwei Vektoren   (*)
        {
        ...
        */
        friend T Cos(const vectorX&v1, const vectorX&v2)              // Cosinus des Winkels zwischen zwei Vektoren (*)
        {
            T val = sqrt(v1.square_absolute_value() * v2.square_absolute_value());
            if (val > std::numeric_limits<T>::epsilon())
            {
        ...
        */
        friend T Tan(const vectorX&v1, const vectorX&v2)
        {
            vectorX<T> v;
            v.cross_product(v1, v2);
        ...
        \return volume
        */
        friend T spat(const vectorX&v1, const vectorX&v2, const vectorX&v3)
        {
            vectorX vx;
        ...
        */
        ...
        \param v2 vector
        */
        void operator += (const vectorX& v2)
        {
            vectorX<T> &v1 = *this;
            size_t size = v2.size();
            if (v1.size() != size)
        ...
        */
        friend vectorX operator*(const vectorX& v, T val)
        {
            vectorX<T> r;
            size_t i, n = v.size();
            r.resize(n);
        ...
        \return result vector
        */
        friend vectorX operator*(T val, const vectorX& v)
        {
            return v * val;
        }
        /*!
...
/*!
 ...
 For the matrix multiplication use the function <i>rke::matrix<T>::multiply(...)</i>
...
*/
    ...
    public:
        ...
        */
        ...
        {
            //cout << "matrix(" << (UINT)row << ", " << (UINT)col << ", " << bzero << endl;
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    /*!
        ...
        */
        ...
        vectorX<T> transformX(vectorX<T>& aInput)
        {
            vectorX<T> fResult;
            if (is_square())
            {
        ...
        */
        ...
        /*!
        \brief reads the matrix content
        \param is input stream (istream&)
        \param m matrix (matrix<T>&)
        \return output stream
        */
        friend std::istream& operator >> (std::istream& os, matrix<T> &m)
        {
            return m.read(os);
        }
    };
