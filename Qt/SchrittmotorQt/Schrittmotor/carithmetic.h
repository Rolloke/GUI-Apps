...
public:
    ...
    sError         setExpression(const char *);
    ...
    void           show() const;
    int            getNumVar() const;
    const char*    getVarName(int) const;
    std::complex<double>* getVarAdress(const char *) const;
...
private:
    ...
    void           show(const tArithmaNode&, int aLevel) const;
