...
String gLine0;
String gLine3;
void print2Decimals(String& fLine, int aNumber)
{
    if (aNumber >= 0)
    {
        if (aNumber < 10) fLine += "0";
        fLine += String(aNumber);
    }
}
...
void PrintLCD_Time()
{
    ...
    String fLine0;
    print2Decimals(fLine0, gSettings.getHours());
    fLine0 += ":";
    print2Decimals(fLine0, gSettings.getMinutes());
    fLine0 += ":";
    int fSeconds = gSettings.getSeconds();
    print2Decimals(fLine0, fSeconds);
    if (fLine0 != gLine0)
    {
        gLCD.setCursor(0, 0);
        gLCD.print(fLine0);
